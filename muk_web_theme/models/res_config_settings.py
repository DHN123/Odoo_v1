...
class ResConfigSettings(models.TransientModel):
    ...
    theme_background_image = fields.Binary(related="company_id.background_image", readonly=False, required=True)
    ...
    def _get_scss_values(self):
        ...
        if custom_attachment.exists():
            ...
            return {
                'theme_color_brand': brand and brand.group(1) or "#875A7B",
                'theme_color_primary': primary and primary.group(1) or "#00A09D",
            }
        else:
            return {
                'theme_color_brand': "#875A7B",
                'theme_color_primary': "#00A09D",
            }
    
    def _build_custom_scss_template(self):
        return TEMPLATE.format(
            self.theme_color_brand or "#875A7B",
            self.theme_color_primary or "#00A09D"
        )
